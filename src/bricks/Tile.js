  ...
  return (
    <div>
      ...
      <Card
        ...
        onClick={() =>
          //   navigate(`/project/${project.id}`, { state: { project, instructor } })
      ...
      >
        ...
        >
          <strong style={{ fontSize: "20px", marginBottom: "13px" }}>
            {" "}
            {project.name}{" "}
          </strong>
          <u>{"Instructor:"}</u>
          <div style={{ marginBottom: "7px" }}>
            {/* {project.instructor.name ? project.instructor.name : "Unknown"} */}
          </div>
          <u>{"Event date:"}</u>
          <div style={{ marginBottom: "7px" }}>
